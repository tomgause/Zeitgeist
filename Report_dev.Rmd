...
Majors.Z = c("Undeclared", "Environmental Studies", "Economics", 
             ...
             "Biology", "Mathematics", "International Politics and Economics", 
             "History", "History of Art & Architecture", 
             "Film and Media Culture", "Geography", "Anthropology", "Physics", 
             "Spanish", "Chemistry", "Sociology", "Theatre", 
             "Education Studies", "Music", "Philosophy", "Chinese", "Geology", 
             "Biochemistry", "Independent Scholar", "Studio Art", 
             "Arabic", "Gender, Sexuality and Feminist Studies", "German",
             "Classics", "Japanese Studies", "Dance", "Russian", "French",
             "Religion", "American Studies", "Comparitive Literature",
             "Literature Studies", "Sociology/Anthropology", "Black Studies")
vals.Z = c(162, 125, 113, 70, 68, 88, 60, 58, 50, 38, 35, 48, 44, 35, 33, 30, 
         25, 24, 25, 23, 22, 21, 17, 17, 15, 14, 13, 11, 10, 10, 7, 12, 
         12, 12, 6, 5, 5, 5, 4, 4, 3, 3, 3, 3, 2)
Major.Data.Raw <- data.frame(Major = Majors.Z,
                         Zeitgeist = vals.Z)
```  
...
After removing the "I prefer not to answer" data, the Class Year variable matched trivially and was deemed ready for permutation testing.  
